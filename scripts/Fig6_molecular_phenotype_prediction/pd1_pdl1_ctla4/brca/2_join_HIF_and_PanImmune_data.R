...
# Load in filtered (by TCGA barcodes in PanImmune dataset) dataframes 
...
write.csv(pd1.use, file="data/genetic_data/PanImmune/datasets/brca.PD1.joined.USE.csv")
saveRDS(pd1.use, file="data/genetic_data/PanImmune/datasets/brca.PD1.joined.USE.rds")
write.csv(pd1.hold.out, file="data/genetic_data/PanImmune/datasets/brca.PD1.joined.HOLDOUT.csv")
saveRDS(pd1.hold.out, file="data/genetic_data/PanImmune/datasets/brca.PD1.joined.HOLDOUT.rds")

pdl1.use <- use[,-c(608, 610, 611)]
pdl1.hold.out <- holdout[,-c(608, 610, 611)]
write.csv(pdl1.use, file="data/genetic_data/PanImmune/datasets/brca.PDL1.joined.USE.csv")
saveRDS(pdl1.use, file="data/genetic_data/PanImmune/datasets/brca.PDL1.joined.USE.rds")
write.csv(pdl1.hold.out, file="data/genetic_data/PanImmune/datasets/brca.PDL1.joined.HOLDOUT.csv")
saveRDS(pdl1.hold.out, file="data/genetic_data/PanImmune/datasets/brca.PDL1.joined.HOLDOUT.rds")

ctla4.use <- use[,-c(608, 609, 611)]
ctla4.hold.out <- holdout[,-c(608, 609, 611)]
write.csv(ctla4.use, file="data/genetic_data/PanImmune/datasets/brca.CTLA4.joined.USE.csv")
saveRDS(ctla4.use, file="data/genetic_data/PanImmune/datasets/brca.CTLA4.joined.USE.rds")
write.csv(ctla4.hold.out, file="data/genetic_data/PanImmune/datasets/brca.CTLA4.joined.HOLDOUT.csv")
saveRDS(ctla4.hold.out, file="data/genetic_data/PanImmune/datasets/brca.CTLA4.joined.HOLDOUT.rds")
